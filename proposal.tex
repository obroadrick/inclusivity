...
to be added and describe main themes


\section{Proposed Actions}\label{proposed actions}
% mention the broad themes that were brought up
% orgs aren't treated equally or valued equally by the department 
...
\footnote[1]{
%\href{https://www.clemson.edu/otei/documents/Teaching%20Review%20Resources/Diversity_InclusionSyllabiSamples.pdf}
...
% faculty publication of office hours, office spaces. 
...
% introduction of orgs (WICS & ACM) in CS1010 ... department meetings with org Co-chairs (beginning of each semester, transparency for communication, who to email, etc.)
% clear documention for org funding (for funding from department, not from SA)
