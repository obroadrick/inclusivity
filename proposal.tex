...
\date{%
    ...
    $^2$President, SEAS Student Peer Advisory Network (SEASSPAN)\\
    $^3$Vice President, Association for Computing Machinery (ACM)\\
    $^4$Undergraduate Representative, Curriculum Committee\\
    $^5$Senior Class Representative, WiCS\\
    $^6$President, ACM\\
    -\\
    28 February 2021
}
